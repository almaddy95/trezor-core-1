...
class TestNemMultisig(unittest.TestCase):
    ...
    def test_nem_multisig(self):
        ...
        # from test data
        # public_key = unhexlify("59d89076964742ef2a2089d26a5aa1d2c7a7bb052a46c1de159891e91ad3d76e")
        # signature = unhexlify("933930a8828b560168bddb3137df9252048678d829aa5135fa27bb306ff6562efb92755462988b852b0314bde058487d00e47816b6fb7df6bcfd7e1f150d1d00")
        # todo this would need to create ed25519_verify_ keccak do we want that??
        # print(ed25519.verify(public_key,
        #                signature,
        #                multisig))
